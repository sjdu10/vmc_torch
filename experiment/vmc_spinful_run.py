...
from vmc_torch.hamiltonian import square_lattice_spinless_Fermi_Hubbard, square_lattice_spinful_Fermi_Hubbard
...
sampler = MetropolisExchangeSamplerSpinful(hi, graph, N_samples=N_samples, burn_in_steps=16, reset_chain=False, random_edge=True, dtype=dtype)
# sampler = None
