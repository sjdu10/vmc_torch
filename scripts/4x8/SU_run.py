...
cpf = 1
cpf_target_sites_po = [(x,y) if (y==0 or y==7 or y==1 or y==6) else None for x in range(Lx) for y in range(Ly)]
cpf_target_sites_ne = []
cpf_target_sites = {
...
spf = 1
spf_target_sites_po = [(x,y) if ((x+y)%2==0 and y<=2) or ((x+y)%2==1 and y>=5) else None for x in range(Lx) for y in range(Ly)]
spf_target_sites_ne = [(x,y) if ((x+y)%2==1 and y<=2) or ((x+y)%2==0 and y>=5) else None for x in range(Lx) for y in range(Ly)]
