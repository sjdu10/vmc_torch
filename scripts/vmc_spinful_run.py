...
# )
# model = fTN_backflow_attn_Tensorwise_Model_v3(
#     peps,
#     max_bond=chi,
#     embedding_dim=16,
#     attention_heads=4,
...
#     embedding_dim=16,
#     attention_heads=4,
#     nn_final_dim=4*peps.nsites,
#     nn_eta=1.0,
#     dtype=dtype,
# )
init_std = float(model.get_tn_params_vec().std())*0.1 # 5e-3
...
model_names = {
    ...
    fTN_backflow_attn_Tensorwise_Model_v2: 'fTN_backflow_attn_Tensorwise_v2',
    fTN_backflow_attn_Tensorwise_Model_v3: 'fTN_backflow_attn_Tensorwise_v3',
    fTN_BFA_cluster_Model: 'fTN_BFA_cluster',
    fTN_BFA_cluster_Model_reuse: 'fTN_BFA_cluster_reuse',
}
...
# sampler = MetropolisExchangeSamplerSpinful(H.hilbert, graph, N_samples=N_samples, burn_in_steps=0, reset_chain=False, random_edge=False, equal_partition=True, dtype=dtype)
...
sampler.debug = False
if N_f == int(Lx*Ly):
    sampler.current_config = torch.tensor([1,2,1,2,1,2,
                                        2,1,2,1,2,1,
                                        1,2,1,2,1,2,
                                        2,1,2,1,2,1,
                                        1,2,1,2,1,2,
