...
run_script = 'python vmc_spinful_1d_run_input_L.py '
...
model = fMPS_BFA_cluster_Model_reuse(mps, embedding_dim=16, attention_heads=4, nn_final_dim=int(L/2), nn_eta=1.0, radius=nn_radius, dtype=dtype)
...
model_names = {
    ...
    fMPS_BFA_cluster_Model: f'fMPS_BFA_cluster_r={nn_radius}',
    fMPS_BFA_cluster_Model_reuse: f'fMPS_BFA_cluster_reuse_r={nn_radius}',
}
