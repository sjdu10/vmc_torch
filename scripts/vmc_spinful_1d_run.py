...
run_script = 'mpirun -n 1 python vmc_spinful_1d_run.py'
...
model = fMPS_BFA_cluster_Model_reuse(mps, embedding_dim=16, attention_heads=4, nn_final_dim=D, nn_eta=1.0, radius=1, dtype=dtype)
...
sampler = MetropolisExchangeSamplerSpinful_1D_reusable(H.hilbert, graph, N_samples=N_samples, burn_in_steps=20, reset_chain=False, random_edge=False, equal_partition=False, dtype=dtype)
