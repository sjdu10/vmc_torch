...
from vmc_torch.experiment.tests.dev.hamiltonian_old import spinful_Fermi_Hubbard_chain, spinful_Fermi_Hubbard_chain_quimb
...
if __name__ == "__main__":
    ...
    record_file = open(f'../../data/L={L}/t={t}_U={U}/N={N_f}/{symmetry}/D={D}/{model_name}/chi={chi}/record{init_step}.txt', 'w')
    if RANK == 0:
        ...
        print(f"1D Fermi-Hubbard chain: L={L}, t={t}, U={U}, N={N_f}, symmetry={symmetry}")
