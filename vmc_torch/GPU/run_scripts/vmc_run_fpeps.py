...
vmc_cfg = VMCConfig(
    ...
    use_log_amp=True,
    use_export_compile=False, # Set to True if you want model compilation (can reduce runtime for model forward but may slow down the first few steps due to compilation overhead)
    save_every=10,
    resume_step=0,
    verbose=False,
)
